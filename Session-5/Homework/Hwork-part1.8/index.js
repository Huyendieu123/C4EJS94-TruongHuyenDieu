...
for (let i = 0; i < arraytmp.length; i++) {
    ...
    s += array2[vitriarray2].array1[arraytmp1[0]] +  '\n' + array2[vitriarray2].array1[arraytmp1[1]] +'\n' + array2[vitriarray2].array1[arraytmp1[2]] +'\n' + array2[vitriarray2].array1[arraytmp1[3]];
    prompt(s);
}